...
if echo "$REGISTER" | grep -q '"success":true'; then
    ...
    echo "   → Add MONGODB_URI variable:"
    echo ""
    echo "   mongodb+srv://mehak24_db_user:mehak15@organicwebsite.jfcdjaq.mongodb.net/organicshop?retryWrites=true&w=majority&appName=organicwebsite"
    echo ""
